...
subdir {ghsrc}`control`

- From 64-bit floating-point to custom fixed-point.
  - [OSVB: fpconv ](https://umarcor.github.io/osvb/notebook/fpconv): data type exploration and visualization in arithmetic algorithms/circuits.
...
- From an isolated core to a software-hardware partitioned design.
  - Introduction to VUnit's AXI [verification components](http://vunit.github.io/verification_components/user_guide.html).
